...
public class helper_ezdevaj extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "ezdevaj.db";
    public static final String TABLE_NAME = "ezdevaj";
    ...
    public helper_ezdevaj(Context context) {
    ...
    public boolean insertEzdevaj (String txt, String txt2, String code, String lan) {
        Cursor res = getData(code);
        if (res.getCount() > 0){
            updateEzdevaj(txt, txt2, code, lan);
        }else{
    ...
    public boolean updateEzdevaj (String txt, String txt2, String code, String lan) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_TXT , encode(txt));
        contentValues.put(COLUMN_TXT2 , encode(txt2));
    ...
    public Integer deleteEzdevaj (Integer id) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<String> getAllEzdevaj() {
