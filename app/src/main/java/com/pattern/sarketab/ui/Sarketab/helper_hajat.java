...
public class helper_hajat extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "hajat.db";
    public static final String TABLE_NAME = "hajat";
    ...
    public helper_hajat(Context context) {
    ...
    public boolean insertHajat (String txt, String txt2, String code, String lan) {
        Cursor res = getData(code);
        if (res.getCount() > 0){
            updateHajat(txt, txt2, code, lan);
        }else{
    ...
    public boolean updateHajat (String txt, String txt2, String code, String lan) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_TXT , encode(txt));
        contentValues.put(COLUMN_TXT2 , encode(txt2));
    ...
    public Integer deleteHajat(Integer id) {
        SQLiteDatabase db = this.getWritableDatabase();
