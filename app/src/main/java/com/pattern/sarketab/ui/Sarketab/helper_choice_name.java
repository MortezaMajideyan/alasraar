...
public class helper_choice_name extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "choice_name.db";
    public static final String TABLE_NAME = "choice_name";
    ...
    public helper_choice_name(Context context) {
    ...
    public boolean insertChoice_name (String txt, String txt2, String code, String lan) {
        Cursor res = getData(code);
        if (res.getCount() > 0){
            updateChoice_name(txt, txt2, code, lan);
        }else{
    ...
    public boolean updateChoice_name (String txt, String txt2, String code, String lan) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_TXT , encode(txt));
        contentValues.put(COLUMN_TXT2 , encode(txt2));
    ...
    public Integer deleteChoice_name(Integer id) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<String> getAllChoice_name() {
