...
public class helper_death extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "death.db";
    ...
    public helper_death(Context context) {
    ...
    public boolean insertDeath (String txt, String txt2, String code, String lan) {
        Cursor res = getData(code);
        if (res.getCount() > 0){
            updateDeath(txt, txt2, code, lan);
        }else{
    ...
    public boolean updateDeath (String txt, String txt2, String code, String lan) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_TXT , encode(txt));
        contentValues.put(COLUMN_TXT2 , encode(txt2));
    ...
    public Integer deleteDeath(Integer id) {
        SQLiteDatabase db = this.getWritableDatabase();
