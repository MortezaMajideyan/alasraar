...
public class helper_sherakat extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "sherakat.db";
    public static final String TABLE_NAME = "sherakat";
    ...
    public helper_sherakat(Context context) {
    ...
    public boolean insertSherakat (String txt, String txt2, String code, String lan) {
        Cursor res = getData(code);
        if (res.getCount() > 0){
            updateSherakat(txt, txt2, code, lan);
        }else{
    ...
    public boolean updateSherakat (String txt, String txt2, String code, String lan) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_TXT , encode(txt));
        contentValues.put(COLUMN_TXT2 , encode(txt2));
    ...
    public Integer deleteSherakat(Integer id) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<String> getAllSherakat() {
