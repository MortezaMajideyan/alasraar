...
public class helper_changename extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "changename.db";
    public static final String TABLE_NAME = "changename";
    ...
    public helper_changename(Context context) {
    ...
    public boolean insertChangename (String txt, String txt2, String code, String lan) {
        Cursor res = getData(code);
        if (res.getCount() > 0){
            updateChangename(txt, txt2, code, lan);
        }else{
    ...
    public boolean updateChangename (String txt, String txt2, String code, String lan) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_TXT , encode(txt));
        contentValues.put(COLUMN_TXT2 , encode(txt2));
    ...
    public Integer deleteChangename(Integer id) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<String> getAllChangename() {
