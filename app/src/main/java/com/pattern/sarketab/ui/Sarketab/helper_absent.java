...
public class helper_absent extends SQLiteOpenHelper {
    ...
    public helper_absent(Context context) {
    ...
    public boolean insertAbsent (String txt, String txt2, String code, String lan) {
        Cursor res = getData(code);
        if (res.getCount() > 0){
            updateAbsent(txt, txt2, code, lan);
        }else{
    ...
    public boolean updateAbsent (String txt, String txt2, String code, String lan) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_TXT , encode(txt));
        contentValues.put(COLUMN_TXT2 , encode(txt2));
    ...
    public Integer deleteAbsent(Integer id) {
        SQLiteDatabase db = this.getWritableDatabase();
